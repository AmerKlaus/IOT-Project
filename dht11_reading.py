...
# Add global variable to track fan (motor) status
fanOn = False
...
def check_for_yes_reply():
    ...
    try:
        ...
        # Search for unread messages with "yes" reply
                        ...
                        for part in msg.walk():
                            if part.get_content_type() == "text/plain":
                                ...
                                if "yes" in body.lower():
                                    # Run motor control in a separate thread
    ...
    return False  # If no "yes" reply, return False
